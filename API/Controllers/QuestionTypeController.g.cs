...
{
    /// <summary>
    /// Controller responsible for managing questiontype-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class QuestionTypeController : ControllerBase
    {
        ...
        public QuestionTypeController(SchoolManagement_localContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new questiontype to the database</summary>
        ...
        {
            _context.QuestionType.Add(model);
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.QuestionType.IncludeRelated().AsQueryable();
            int skip = (pageNumber - 1) * pageSize;
            var result = FilterService<QuestionType>.ApplyFilter(query, filterCriteria, searchTerm);
        ...
        {
            var entityData = _context.QuestionType.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.QuestionType.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] QuestionType updatedEntity)
        {
            ...
            this._context.QuestionType.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<QuestionType> updatedEntity)
        {
            ...
            var existingEntity = this._context.QuestionType.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.QuestionType.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
