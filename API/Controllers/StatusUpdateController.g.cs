...
{
    /// <summary>
    /// Controller responsible for managing statusupdate-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class StatusUpdateController : ControllerBase
    {
        ...
        public StatusUpdateController(SchoolManagement_localContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new statusupdate to the database</summary>
        ...
        {
            _context.StatusUpdate.Add(model);
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.StatusUpdate.IncludeRelated().AsQueryable();
            int skip = (pageNumber - 1) * pageSize;
            var result = FilterService<StatusUpdate>.ApplyFilter(query, filterCriteria, searchTerm);
        ...
        {
            var entityData = _context.StatusUpdate.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.StatusUpdate.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] StatusUpdate updatedEntity)
        {
            ...
            this._context.StatusUpdate.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<StatusUpdate> updatedEntity)
        {
            ...
            var existingEntity = this._context.StatusUpdate.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.StatusUpdate.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
