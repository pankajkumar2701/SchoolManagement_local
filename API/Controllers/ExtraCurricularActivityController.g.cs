...
{
    /// <summary>
    /// Controller responsible for managing extracurricularactivity-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class ExtraCurricularActivityController : ControllerBase
    {
        ...
        public ExtraCurricularActivityController(SchoolManagement_localContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new extracurricularactivity to the database</summary>
        ...
        {
            _context.ExtraCurricularActivity.Add(model);
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.ExtraCurricularActivity.IncludeRelated().AsQueryable();
            int skip = (pageNumber - 1) * pageSize;
            var result = FilterService<ExtraCurricularActivity>.ApplyFilter(query, filterCriteria, searchTerm);
        ...
        {
            var entityData = _context.ExtraCurricularActivity.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.ExtraCurricularActivity.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] ExtraCurricularActivity updatedEntity)
        {
            ...
            this._context.ExtraCurricularActivity.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<ExtraCurricularActivity> updatedEntity)
        {
            ...
            var existingEntity = this._context.ExtraCurricularActivity.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.ExtraCurricularActivity.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
