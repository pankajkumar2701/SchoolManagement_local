...
{
    /// <summary>
    /// Controller responsible for managing emergencycontact-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class EmergencyContactController : ControllerBase
    {
        ...
        public EmergencyContactController(SchoolManagement_localContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new emergencycontact to the database</summary>
        ...
        {
            _context.EmergencyContact.Add(model);
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.EmergencyContact.IncludeRelated().AsQueryable();
            int skip = (pageNumber - 1) * pageSize;
            var result = FilterService<EmergencyContact>.ApplyFilter(query, filterCriteria, searchTerm);
        ...
        {
            var entityData = _context.EmergencyContact.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.EmergencyContact.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] EmergencyContact updatedEntity)
        {
            ...
            this._context.EmergencyContact.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<EmergencyContact> updatedEntity)
        {
            ...
            var existingEntity = this._context.EmergencyContact.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.EmergencyContact.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
