...
{
    /// <summary>
    /// Controller responsible for managing archivelocation-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class ArchiveLocationController : ControllerBase
    {
        ...
        public ArchiveLocationController(SchoolManagement_localContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new archivelocation to the database</summary>
        ...
        {
            _context.ArchiveLocation.Add(model);
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.ArchiveLocation.IncludeRelated().AsQueryable();
            int skip = (pageNumber - 1) * pageSize;
            var result = FilterService<ArchiveLocation>.ApplyFilter(query, filterCriteria, searchTerm);
        ...
        {
            var entityData = _context.ArchiveLocation.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.ArchiveLocation.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] ArchiveLocation updatedEntity)
        {
            ...
            this._context.ArchiveLocation.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<ArchiveLocation> updatedEntity)
        {
            ...
            var existingEntity = this._context.ArchiveLocation.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.ArchiveLocation.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
