namespace SchoolManagement_local.Services
{
    using System;
    ...
    {
        private SchoolManagement_localContext _dbContext;
        public UserAuthenticationService(SchoolManagement_localContext dbContext)
        {
