...
using SchoolManagement_local.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "SchoolManagement_local", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<SchoolManagement_localContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "SchoolManagement_local API v1");
